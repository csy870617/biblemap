...
export const THEMES: BibleMapTheme[] = [
  ...
  },
  {
    id: 'judges',
    title: '사사 시대',
    subtitle: '왕이 없던 시대, 반복된 구원의 역사',
    testament: 'OT',
    kind: 'region',
    book: '사사기',
    era: '약 BC 1380~1050년경',
    year: -1200,
    color: '#ea580c',
    icon: '⚔️',
    summary:
      '여호수아 사후 사울이 왕이 되기까지, "그때에 이스라엘에 왕이 없으므로 각기 자기 소견에 옳은 대로 행하였더라"(사사기 21:25)는 말씀대로 배교→압제→부르짖음→사사를 통한 구원이 반복된 약 300년입니다. 드보라·기드온·삼손 등 사사들의 활동 무대를 지도로 보면 이 혼란기의 지리적 배경이 뚜렷해집니다.',
    locations: [
      { id: 'judges-shiloh', name: '실로', nameEn: 'Shiloh', coord: [32.0550, 35.2890], refs: ['사사기 21:19'], desc: '언약궤가 머물며 매년 절기를 지키던 사사 시대 이스라엘의 종교적 중심지.' },
      { id: 'judges-tabor', name: '다볼산', nameEn: 'Mount Tabor', coord: [32.6875, 35.3919], refs: ['사사기 4:6'], desc: '여선지자 드보라와 바락이 군사를 모아 가나안 장군 시스라의 철병거 부대를 물리친 전투의 출발지.' },
      { id: 'judges-en-harod', name: '하롯 샘', nameEn: 'Well of Harod', coord: [32.5386, 35.3861], refs: ['사사기 7:1-7'], desc: '기드온이 물 마시는 방법으로 300용사를 추려 미디안 대군을 물리친 "적은 수로 구원하시는" 믿음의 현장.' },
      { id: 'judges-mizpah-gilead', name: '미스바(길르앗)', nameEn: 'Mizpah of Gilead', coord: [32.3667, 35.7833], refs: ['사사기 11:11', '사사기 11:34'], desc: '쫓겨났던 입다가 암몬과의 전쟁을 위해 지도자로 세워지고, 승리 후 딸을 만난 서원의 현장.' },
      { id: 'judges-zorah', name: '소라', nameEn: 'Zorah', coord: [31.7592, 34.9908], refs: ['사사기 13:2', '사사기 13:24'], desc: '삼손이 태어나고 여호와의 영에 감동되기 시작한 단 지파 마을.' },
      { id: 'judges-timnah', name: '딤나', nameEn: 'Timnah', coord: [31.7742, 34.9494], refs: ['사사기 14장'], desc: '삼손이 블레셋 여인과 혼인하며 수수께끼 사건이 벌어진 곳. 블레셋과의 오랜 갈등이 시작됩니다.' },
      { id: 'judges-gaza', name: '가사', nameEn: 'Gaza', coord: [31.5017, 34.4668], refs: ['사사기 16:21-30'], desc: '삼손이 붙잡혀 눈이 뽑히고, 마지막으로 다곤 신전을 무너뜨리며 함께 죽은 블레셋의 성읍.' },
      { id: 'judges-dan', name: '단(단 지파의 이주)', nameEn: 'Dan', coord: [33.2486, 35.6528], refs: ['사사기 18장'], desc: '기업이 좁아 살기 힘들었던 단 지파가 북쪽 라이스를 정복해 이름을 "단"으로 바꾸고 이주한 곳. "왕이 없으므로 각기 소견대로 행하던" 혼란의 단면입니다.' },
    ],
  },
  {
    id: 'united-kingdom',
    title: '통일왕국 시대',
    subtitle: '사울·다윗·솔로몬, 하나였던 이스라엘',
    testament: 'OT',
    kind: 'journey',
    book: '사무엘상~열왕기상 11장',
    era: '약 BC 1050~930년경',
    ...
    icon: '🏰',
    summary:
      '사무엘이 마지막 사사로 세운 사울이 초대 왕이 되고, 다윗이 헤브론과 예루살렘에서 나라를 굳게 세운 뒤, 솔로몬이 성전을 짓고 나라를 확장한 이스라엘 역사상 가장 영광스러웠던 통일왕국 시대입니다. 사울의 몰락에서 다윗의 왕위, 솔로몬의 번영까지 지도로 이어보면 한 나라가 세워지고 확장되는 과정이 보입니다.',
    locations: [
      { id: 'uk-mizpah', name: '미스바', nameEn: 'Mizpah', coord: [31.9042, 35.1928], refs: ['사무엘상 10:17-24'], desc: '사무엘이 이스라엘을 모으고 제비를 뽑아 사울을 초대 왕으로 세운 곳.' },
      { id: 'uk-gilboa', name: '길보아산', nameEn: 'Mount Gilboa', coord: [32.5000, 35.4200], refs: ['사무엘상 31:1-6'], desc: '블레셋과의 전투에서 사울과 세 아들이 전사하며 첫 왕조가 비극적으로 끝난 곳.' },
      { id: 'uk-ziklag', name: '시글락', nameEn: 'Ziklag', coord: [31.3833, 34.6333], refs: ['사무엘상 27:5-7'], desc: '사울을 피해 도망 다니던 다윗이 블레셋 왕 아기스에게 받아 근거지로 삼은 곳.' },
      { id: 'uk-hebron', name: '헤브론', nameEn: 'Hebron', coord: [31.5326, 35.0998], refs: ['사무엘하 2:1-4', '사무엘하 5:5'], desc: '다윗이 유다의 왕으로 기름부음 받고 예루살렘 정복 전까지 7년 반 동안 다스린 첫 수도.' },
      { id: 'uk-jerusalem', name: '예루살렘', nameEn: 'Jerusalem', coord: [31.7683, 35.2137], refs: ['사무엘하 5:6-10'], desc: '다윗이 여부스 족속의 요새를 정복해 "다윗성"이라 부르고 통일왕국의 수도로 삼은 곳.' },
      { id: 'uk-gibeon', name: '기브온', nameEn: 'Gibeon', coord: [31.8460, 35.1840], refs: ['열왕기상 3:4-15'], desc: '솔로몬이 일천 번제를 드리고 "듣는 마음"(지혜)을 구해 하나님께 응답받은 큰 산당.' },
      { id: 'uk-megiddo', name: '므깃도', nameEn: 'Megiddo', coord: [32.5844, 35.1841], refs: ['열왕기상 9:15', '열왕기상 9:19'], desc: '솔로몬이 병거성으로 요새화한 전략 도시. 해변길(Via Maris)을 지키는 관문이었습니다.' },
      { id: 'uk-gezer', name: '게셀', nameEn: 'Gezer', coord: [31.9261, 34.9186], refs: ['열왕기상 9:15-17'], desc: '애굽 바로가 딸의 결혼 지참금으로 준 성읍을 솔로몬이 재건해 요새화한 곳.' },
    ],
  },
  {
    id: 'divided',
  ...
  },
  {
    ...
    icon: '🏗️',
    summary:
      '바사 왕 고레스의 조서로 포로 생활이 끝나고, 스룹바벨과 에스라, 느헤미야가 차례로 예루살렘에 돌아와 성전과 성벽을 재건한 회복의 역사입니다. "바벨론 포로" 여정을 거꾸로 되짚어보면, 하나님이 약속하신 귀환(예레미야 29:10)이 실제로 이루어진 여정의 규모가 실감납니다.',
    locations: [
      { id: 'return-babylon', name: '바벨론', nameEn: 'Babylon', coord: [32.5424, 44.4208], refs: ['에스라 1:1-4'], desc: '고레스 왕이 조서를 내려 포로 된 백성이 예루살렘으로 돌아가도록 허락한 출발점.' },
      { id: 'return-susa', name: '수산', nameEn: 'Susa', coord: [32.1943, 48.2569], refs: ['느헤미야 1:1', '느헤미야 2:1-8'], desc: '술 관원 느헤미야가 예루살렘 성벽이 무너진 소식을 듣고 기도하며 왕에게 귀환을 허락받은 바사 왕궁이 있던 곳.' },
      { id: 'return-jerusalem', name: '예루살렘', nameEn: 'Jerusalem', coord: [31.7683, 35.2137], refs: ['에스라 3:8', '느헤미야 6:15'], desc: '스룹바벨이 성전 기초를 놓고, 훗날 느헤미야가 52일 만에 성벽 재건을 완성한 회복의 중심지.' },
      { id: 'return-bethel', name: '벧엘', nameEn: 'Bethel', coord: [31.9308, 35.2206], refs: ['에스라 2:28'], desc: '귀환자 명단에 고향으로 기록된 성읍 중 하나로, 흩어졌던 백성이 옛 땅에 다시 정착했음을 보여줍니다.' },
      { id: 'return-jericho', name: '여리고', nameEn: 'Jericho', coord: [31.8607, 35.4444], refs: ['에스라 2:34'], desc: '벧엘과 마찬가지로 귀환자들의 고향 명단에 오른 성읍.' },
      { id: 'return-samaria', name: '사마리아', nameEn: 'Samaria', coord: [32.2806, 35.1900], refs: ['느헤미야 4:1-3'], desc: '총독 산발랏이 성벽 재건을 조롱하고 방해한 근거지. 재건 과정이 순탄치만은 않았음을 보여줍니다.' },
    ],
  },
  {
    id: 'jesus',
