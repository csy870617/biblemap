...
function App() {
  ...
  return (
    <div className="h-screen flex flex-col bg-stone-100">
      {/* Header */}
      <header className="bg-[#1a2744] px-6 py-3 shrink-0 flex items-center gap-3 shadow-md z-10">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {/* Desktop Sidebar */}
        <aside className="hidden lg:block w-[30%] bg-[#f5f0e8] border-l border-[#d6cebf] overflow-y-auto">
          {selectedLocation ? (
